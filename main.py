...
def add_initial_codes():
    ...
    try:
        ...
        if count == 0:
            initial_codes = ['11111', '22222', '33333', '44444', '55555', 
                           '66666', '77777', '88888', '99999', '12345']
            
            for code in initial_codes:
                cur.execute("INSERT INTO codes (code) VALUES (%s) ON CONFLICT (code) DO NOTHING", (code,))
...
def get_customers():
    ...
    try:
        ...
        cur.execute("SELECT id, name, phone, plate_letters, plate_numbers, installation_center, activation_code, activated_at FROM customers ORDER BY activated_at DESC")
